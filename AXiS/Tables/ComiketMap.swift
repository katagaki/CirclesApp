...
public final class ComiketMap: SQLiteable, Identifiable, Hashable {
    public static func == (lhs: ComiketMap, rhs: ComiketMap) -> Bool {
    ...
    public var allFilename: String
    public var configuration: MapConfiguration
    public var hdConfiguration: MapConfiguration
    public var rotation: Int

    public var layouts: [ComiketLayout]?
